...
d2 = VectorValue(0.0,0.8)
geo2 = quadrilateral(;x0=x0,d1=d1,d2=d2)

x0 = Point(0.2,0.6)
d1 = VectorValue(0.7,0.0)
...
# add remotes (itself) to aggregate array



# Implement C shape domain with one thin branch

# Test remotes by changing bgmodel
